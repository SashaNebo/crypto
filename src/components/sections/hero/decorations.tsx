...
export const Decorations = () => {
  return (
    <div className="w-full h-full absolute top-0 left-0 -z-50 overflow-hidden">
      <div className="absolute bottom-[300px] left-0 -translate-x-1/3 -rotate-[12deg] max-lg:top-0 max-lg:left-1/2 max-lg:bottom-auto max-lg:-translate-y-[45%] max-lg:rotate-6">
        <Icon
      ...
      <div className="absolute right-0 bottom-[300px] blur-sm translate-x-[20%] rotate-[8deg]">
